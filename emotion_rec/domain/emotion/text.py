...
try:
    from emotion_rec.core.config import MODELS_DIR
    from emotion_rec.domain.emotion.mapping import EMOTION_LEXICON, clamp, split_text_segments
    ...
    from core.config import MODELS_DIR  # type: ignore
    from domain.emotion.mapping import EMOTION_LEXICON, clamp, split_text_segments  # type: ignore
...
DEFAULT_HEAD_PATH = MODELS_DIR / "text_emotion_head.pt"
